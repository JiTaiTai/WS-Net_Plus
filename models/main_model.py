...
class ChangeDetection(nn.Module):
    ...
    def forward_once(self, xa, xb):
        ...
        # xcat = torch.abs(xa-xb)
        # fx1, fx2, fx3, fx4 = self.backbone(xcat)
        # fx1, fx2, fx3, fx4 = self.check_channels(fx1, fx2, fx3, fx4)
        fa1, fa2, fa3, fa4 = self.backbone(xa)  # feature_a_1: 
        ...
        change, diff1, diff2, diff3, diff4 = self.neck(ms_feats)
    ...
    def forward(self, xa, xb, tta=False):
        ...
        for i, model in enumerate(self.models_list):
            ...
            if "avg" in self.method:
                ...
                # cd_pred1 = out1[:, 1, ...] > 0.45 * len(self.models_list)  
        ...
        if self.models_list[0].dl:
            ...
            return cd_pred1, diff1, diff2, diff3, diff4
